...
//fungsi untuk mengecek kata dalam tabel kata dasar
function cekKamus($kata){
	require('koneksi.php');//Koneksi ke database
	$sql = mysqli_query($con, "SELECT * from tb_kata_dasar where katadasar ='$kata' LIMIT 1");
