...
class Data_testing extends Koneksi {
  ...
  public function set_data_testing() {
    ...
    for ($i=7; $i>=0 ; $i--) {
      ...
      $tanggal_crawling2 = date('Y-m-d', strtotime('-1 days', strtotime( date('Y-m-d') )));
      ...
      $tanggal_crawling3 = date('Y-m-d', strtotime('-1 days', strtotime( date('Y-m-d') )));
      ...
      $this->sentimen_lazada_p["$tanggal_crawling"] = $jumlah_positif1;
      $this->sentimen_lazada_n["$tanggal_crawling"] = $jumlah_negatif1;
      $this->sentimen_bukalapak_p["$tanggal_crawling"] = $jumlah_positif2;
      $this->sentimen_bukalapak_n["$tanggal_crawling"] = $jumlah_negatif2;
      $this->sentimen_tokopedia_p["$tanggal_crawling"] = $jumlah_positif3;
      $this->sentimen_tokopedia_n["$tanggal_crawling"] = $jumlah_negatif3;
    }
