  ...
  <body>
    ...
    <nav class="col-md-2 menu-kiri">
      <ul>
        ...
        <li class="menu-terpilih"><a href="http://localhost/ansen-kota/proses-klasifikasi-bayes.php"><i class="fa fa-table fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;Klasifikasi Sentimen</a></li>
