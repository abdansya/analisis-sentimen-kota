  ...
  <body>
    ...
    <nav class="col-md-2 menu-kiri">
      <ul>
        ...
        <li class="menu-terpilih"><a href="http://localhost/ansen-kota/proses-information-gain.php"><i class="fa fa-balance-scale fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;Bobot IG</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <table class="table table-striped" style="width: 80%; margin:0 auto;">
            ...
            $sql = $pdo->prepare("SELECT * FROM `data_training_kata` ORDER BY `data_training_kata`.`bobot_ig` DESC LIMIT ".$limit_start.",".$limit);
            ...
            <div class="row">
              <div class="col-md-10" style="text-align:center;">
                <ul class="pagination">
                  ...
                  ?>
                    <li><a href="proses-information-gain.php?page=1">First</a></li>
                    <li><a href="proses-information-gain.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                  <?php
                  }
                  ?>
                  ...
                  ?>
                    <li<?php echo $link_active; ?>><a href="proses-information-gain.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                  <?php
                  }
                  ?>
                  ...
                  ?>
                    <li><a href="proses-information-gain.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                    <li><a href="proses-information-gain.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                  <?php
                  }
                  ?>
                </ul>
