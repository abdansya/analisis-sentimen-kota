  ...
  <body>
    ...
    <nav class="col-md-2 menu-kiri">
      <ul>
        ...
        <li class="menu-terpilih"><a href="proses-klasifikasi-knn.php"><i class="fa fa-table fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;Klasifikasi Sentimen KNN</a></li>
    ...
    <main class="main container-fluid">
      <div class="row">
        ...
        <div class="col-md-10 main-proses">
          <h3>Klasifikasi K-Nearest Neighbor</h3>
          <hr>
          <form action="model/model_proses_klasifikasi_knn.php" method="get">
            <button type="submit" class="btn btn-info" name="btsubmit" value="bobot_knn">Proses</button>
          </form>
          <br>
            ...
            <thead>
              <tr>
                ...
                <th class="col-md-9">Tweet</th>
								<th class="col-md-2">Sentimen KNN</th>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              $sql = $pdo->prepare("SELECT `id_tes`, `tweet`, `sentimen_knn` FROM `data_testing` WHERE `tanggal` > '".$tanggal_crawling."' ORDER BY `data_testing`.`id_tes` DESC LIMIT ".$limit_start.",".$limit);
              $sql->execute(); // Eksekusi querynya
              $no = $limit_start + 1; // Untuk penomoran tabel

              while ($row = $sql->fetch()) {
              if ($row['sentimen_knn'] == 'P') {
                $sentimen = 'Positif';
              } else if ($row['sentimen_knn'] == 'N'){
                $sentimen = 'Negatif';
              } else {
                $sentimen = '';
              }
            ...
            <div class="row">
              <div class="col-md-10" style="text-align:center;">
                <ul class="pagination">
                  ...
                  ?>
                    <li><a href="proses-klasifikasi-knn.php?page=1">First</a></li>
                    <li><a href="proses-klasifikasi-knn.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                  <?php
                  }
                  ?>
                  ...
                  ?>
                    <li<?php echo $link_active; ?>><a href="proses-klasifikasi-knn.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                  <?php
                  }
                  ?>
                  ...
                  ?>
                    <li><a href="proses-klasifikasi-knn.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                    <li><a href="proses-klasifikasi-knn.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                  <?php
                  }
                  ?>
                </ul>
