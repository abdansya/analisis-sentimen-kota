<?php
include_once 'model/model_training_information_gain.php';
$data = data_bobot_training();
?>
<!DOCTYPE html>
<html>
  <head>
        ...
        <li>
          ...
          <div id="subPages" class="collapse" aria-expanded="false" style="height: 0px;">
            <ul class="sub-nav">
              ...
              <li class="menu-terpilih"><a href="training-information-gain.php" class="sub-menu"><i class="fa fa-balance-scale fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;Information Gain</a></li>
    ...
    <main class="main container-fluid">
      <div class="row">
        ...
        <div class="col-md-10 main-proses">
          ...
          <h5 style="border: 1px solid rgb(193, 193, 193); display: inline-block; padding: 9px;">Entropy Set = <?php echo $ig_entropy->entropy_set(); ?></h5>
          <br>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              $sql = $pdo->prepare("SELECT * FROM `data_training_kata` ORDER BY `id_kata` ASC LIMIT ".$limit_start.",".$limit);
              ...
              <tr>
                ...
                <td class="col-md-2"><?php echo $row['kata']; ?></td>
                <td class="col-md-2"><?php echo $row['entropy_ya']; ?></td>
                <td class="col-md-2"><?php echo $row['entropy_tidak']; ?></td>
                <td class="col-md-2"><?php echo $row['entropy_kata']; ?></td>
                <td class="col-md-3"><?php echo $row['bobot_ig']?></td>
              </tr>
            <?php
            ...
            <div class="row">
              <div class="col-md-10" style="text-align:center;">
                <ul class="pagination">
                  ...
                  ?>
                    <li><a href="training-information-gain.php?page=1">First</a></li>
                    <li><a href="training-information-gain.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                  <?php
                  }
                  ?>
                  ...
                  $sql2 = $pdo->prepare("SELECT COUNT(*) AS jumlah FROM data_training_kata");
                  ...
                  ?>
                    <li<?php echo $link_active; ?>><a href="training-information-gain.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                  <?php
                  }
                  ?>
                  ...
                  ?>
                    <li><a href="training-information-gain.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                    <li><a href="training-information-gain.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                  <?php
                  }
                  ?>
                </ul>
