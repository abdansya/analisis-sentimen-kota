...
include_once 'model/model_proses_bobot_bayes.php';
$data = data_bobot_bayes_testing();
?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <body>
    ...
    <nav class="col-md-2 menu-kiri">
      <ul>
        ...
        <li class="menu-terpilih"><a href="http://localhost/ansen-kota/proses-bobot-bayes.php"><i class="fa fa-shopping-basket fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;Bobot Bayes</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <hr>
            ...
            <button type="submit" class="btn btn-info" name="btsubmit" value="bobot_bayes">Proses</button>
          </form>
          <br>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              $sql = $pdo->prepare("SELECT `id_tes`, `tweet`, `bobot_bayes_positif`, `bobot_bayes_negatif`, `sentimen` FROM `data_testing` WHERE `tanggal` > '".$tanggal_crawling."' ORDER BY `data_testing`.`id_tes` DESC LIMIT ".$limit_start.",".$limit);
            ...
            <div class="row">
              <div class="col-md-10" style="text-align:center;">
                <ul class="pagination">
                  ...
                  ?>
                    <li><a href="proses-bobot-bayes.php?page=1">First</a></li>
                    <li><a href="proses-bobot-bayes.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                  <?php
                  }
                  ?>
                  ...
                  ?>
                    <li<?php echo $link_active; ?>><a href="proses-bobot-bayes.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                  <?php
                  }
                  ?>
                  ...
                  ?>
                    <li><a href="proses-bobot-bayes.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                    <li><a href="proses-bobot-bayes.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                  <?php
                  }
                  ?>
                </ul>
