  ...
  <body>
    ...
    <nav class="col-md-2 menu-kiri">
      <ul>
        ...
        <li class="menu-terpilih"><a href="http://localhost/ansen-kota/proses-preprocessing.php"><i class="fa fa-retweet fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;Preprocessing</a></li>
        ...
        <div class="col-md-10">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              $sql = $pdo->prepare("SELECT * FROM `data_testing` ORDER BY `id_tes` DESC LIMIT ".$limit_start.",".$limit);
              $sql->execute(); // Eksekusi querynya
              $no = $limit_start + 1; // Untuk penomoran tabel

              while ($row = $sql->fetch()) { ?>
              <tr>
                <td class="col-md-2"><?php echo $row['id_tes']; ?></td>
            ...
            <div class="row">
              <div class="col-md-10" style="text-align:center;">
                <ul class="pagination">
                  ...
                  ?>
                    <li><a href="proses-preprocessing.php?page=1">First</a></li>
                    <li><a href="proses-preprocessing.php?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                  <?php
                  }
                  ?>
                  ...
                  ?>
                    <li<?php echo $link_active; ?>><a href="proses-preprocessing.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                  <?php
                  }
                  ?>
                  ...
                  ?>
                    <li><a href="proses-preprocessing.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                    <li><a href="proses-preprocessing.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                  <?php
                  }
                  ?>
                </ul>
